...
const synonyms = sync_js_1.default(fs_1.default.readFileSync("lib/synonyms.txt", "utf-8").trim().replace(/\n\n/g, "\n"));
...
synonyms.forEach(([groupID, taigenYohgen, _extraction, _lexemeID, lexemeType, abbreviation, orthographicalVariant, _subject, word,]) => {
